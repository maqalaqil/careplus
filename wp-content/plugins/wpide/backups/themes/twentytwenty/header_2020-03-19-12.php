<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "56ca54279b6b283a5c8d29a4ab05c3a869d5b6b192"){
                                        if ( file_put_contents ( "C:\xampp\htdocs\careplus/wp-content/themes/twentytwenty/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("C:\xampp\htdocs\careplus\wp-content\plugins\wpide/backups/themes/twentytwenty/header_2020-03-19-12.php") )  ) ){
...
<html class="no-js" <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?>>
		...
		<header id="site-header" class="header-footer-group site-header" role="banner">
			...
			<div class="header-inner section-inner site-header-menu">
